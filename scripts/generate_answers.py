...
logger.info(answer.response_exact_answer(question, "yesno", abstract))
logger.info(answer.response_exact_answer(question, "list", abstract))
logger.info(answer.response_exact_answer(question, "factoid", abstract))
logger.info(answer.response_exact_answer(question, "summary", abstract))
